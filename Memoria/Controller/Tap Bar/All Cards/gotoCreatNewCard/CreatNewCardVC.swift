...
//    @IBOutlet weak var PickerViewOut: UIPickerView!
    ...
    override func viewDidLoad() {
        ...
        //        setCardView(view: FrontVOut)
        //        setCardView(view: FrontTVOut)
        //        setCardView(view: FrontPlusImageOut)
        //
        //        setCardView(view: BackVOut)
        //        setCardView(view: BackTVOut)
        //        setCardView(view: BackPlusImageOut)
        //        setCardView(view: CardStatusVOut)
        //
